    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button className="flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-600/20 transition-all hover:bg-indigo-700">
                  ...
                  <tr key={item.id} className="transition-colors hover:bg-slate-50/50 group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button className="rounded-lg bg-slate-50 p-2 text-slate-400 hover:bg-slate-100 transition-colors">
